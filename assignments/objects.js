...
const parent = {
    name: 'Susan',
    age: 78,
    child: {name: 'George', age: 50, speak: function() {return `Hi. My name is ${this.name}`}, grandchild: {name: 'Sam', age: 30, speak: function() {return `Hi. My name is ${this.name}`}}},
//    speak: () => `My name is ${this['name']}`   Not sure why arrow function syntax returns undefined...
